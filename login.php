...
<body>
    ...
    <div class="container">
        ...
        <div class="form-box <?= activeForm('register', $activeForm) ?>" id="register-form">
            <form action="login_register.php" method="post" onsubmit="return validatePassword()">
                <h2>Register</h2>
                ...
                <button type="submit" name="register" onclick="showForm('login-form')">Register</button>
